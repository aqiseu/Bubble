...
public class Bubble1Adapter extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] itemname;
    private final Integer[] imgid;

    public Bubble1Adapter(Activity context, String[] itemname, Integer[] imgid) {
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        ImageView imageView = (ImageView) rowView.findViewById(R.id.imagev1);
        TextView extratxt = (TextView) rowView.findViewById(R.id.textharga1);
